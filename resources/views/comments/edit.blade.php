...
@section('content')
        ...
        <div class="comment">
            <div style="margin: 0;margin-bottom: 15px;">
                ...
                <form action="{{route('comments.update',[$twit->id,$comment->id])}}" method="post">
                    ...
                    <textarea maxlength="200" name="text" required class="comment_text"
                              style="background: none; border: none">{{$comment->text}}</textarea>
    ...
    right: 32%;">
                        <img src="{{URL::to('/')}}\img\for_interface\no_like_twit.png" style="width: 24px"
                             class="likes_button">
                        <img src="{{URL::to('/')}}\img\for_interface\answer.png" style="width: 24px"
                             class="likes_button">
